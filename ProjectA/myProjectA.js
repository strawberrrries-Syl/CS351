// zlv8102 
// projectA, start from starting code.
...
//==============================================================================
  ...
  //
  //SIMPLE VERSION:  gl = getWebGLContext(g_canvasID);   ---> other examples used
  ...
  gl = g_canvasID.getContext("webgl", { preserveDrawingBuffer: true});
	...
	// make an on-screen button to enable/disable screen clearing? )						===> TRY IT
  ...
  var myErr = initVertexBuffers(); // sets global var 'g_vertCount'							===> get vertecies information?
  if (myErr < 0) {
...
// ==============ANIMATION=============
  ...
  var tick = function() {		    // locally (within main() only), define our 
    ...
    requestAnimationFrame(tick, g_canvasID); // browser callback request; wait					===> iteration
